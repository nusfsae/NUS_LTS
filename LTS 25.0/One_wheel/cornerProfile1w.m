...
function BSP = cornerProfile1w(mass,C2,air_density,frontel_area,CLc,tyre_model,camber,max_rpm,FDR,R,tc_lat,sen_lat,phit,P,useMode)
...
for point = 1:num
    ...
    if abs(curv) > 30 %radius too large, track is straight
        ...
        BSP(point) = calculateCornerV1w(tyre_model,mass,air_density,frontel_area,CLc,curv,camber,alpha,max_rpm,FDR,R,tc_lat,sen_lat,phit,P,useMode);
