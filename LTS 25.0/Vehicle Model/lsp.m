function final_lsp = lsp(C2,dist,camber,tyre_model,mass,air_density,frontel_area,CLs,CLc,CDs,CDc,Accel_LSP,tc_long,sen_long)
...
for point = 1:count-1 %for every interval between 2 local minima
    ...
    for i = 0:local_min(point,2) %for every point in the interval
        ...
        braked_v = v_finder(v1,v2,distance,camber,SA,tyre_model,mass,air_density,frontel_area,CL,CD,tc_long,sen_long);
