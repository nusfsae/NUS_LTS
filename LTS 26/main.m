...
settings.chassis.massFront = settings.chassis.mass
...
settings.aero.farea = 1.157757;  % frontal area (m^2)
...
GGV_settings.velocityRange = linspace(10,settings.powertrain.max_speed-5, Vnum); % Discrete Velocity Points
