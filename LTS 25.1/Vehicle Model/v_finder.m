...
%(v1>v2)
function velocity = v_finder(v1,v2,dist,camber,slip_ang,tyre_model,mass,air_density,frontel_area,CL,CD)
velocity = v1;

for vel = v1:-0.1:v2
    
    Reaction_f = 0.25*(mass*9.81 + 0.5*air_density*frontel_area*CL*(vel^2));%normal load under this speed
    ...
    Long = 4*0.67*Long; %Tire correlation factor
