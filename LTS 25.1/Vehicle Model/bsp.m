...
function BSP = bsp(mass,C2,air_density,frontel_area,CLc,max_speed,tyre_model,camber,steer_max)
...
for point = 1:num
    ...
    if abs(curv) > 30 %radius too large, track is straight
        ...
        BSP(point) = v_calculater(tyre_model,mass,air_density,frontel_area,CLc,curv,camber,max_speed,steer_max);%find max corner speed using this function
