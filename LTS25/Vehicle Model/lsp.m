function final_lsp = lsp(C2,dist,camber,tyre_model,mass,air_density,frontel_area,coef_drag,Accel_LSP)
...
for point = 1:count-1 %for every interval between 2 local minima
    ...
    for i = 0:local_min(point,2) %for every point in the interval
        ...
        braked_v = v_finder(v1,v2,distance,camber,SA,tyre_model,mass,air_density,frontel_area,coef_drag); %velocity after braking with these conditions
