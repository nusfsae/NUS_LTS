...
function BSP = bsp(mass,pos,C2,air_density,frontel_area,coef_lift,max_speed,tyre_model,camber)
...
for point = 1:num
    ...
    if abs(curv) > 30 %radius too large, track is straight
        ...
        BSP(point) = v_calculater(tyre_model,mass,air_density,frontel_area,coef_lift,curv,camber,alpha,max_speed);%find max corner speed using this function
